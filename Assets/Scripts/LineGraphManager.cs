...
public class LineGraphManager : MonoBehaviour {
	...
	private float highestValue = 180;
	...
	public IEnumerator ImportData(){
		...
		for(int i = 0; i < index; i++){
			...
			//gd.marbles = Random.Range(10,180);
			gd.marbles = (int) actualData[i];
			graphDataPlayer1.Add(gd);
			GraphData gd2 = new GraphData();
			//gd2.marbles = Random.Range(10,180);
			gd2.marbles = (int) predictionData[i];
